...
elixir(function (mix) {
  ...
  var assets = [
    ...
    scripts = [
      ...
      './public/js/app.js',
      //'./public/js/calendar/time.js',
      './public/dist/js/app.js'
    ],
    styles = [

      './bower_components/trix/dist/trix.css',
      './public/css/smart_wizard.min.css',
      './public/css/smart_wizard_theme_arrows.min.css',
      './public/css/evergenius.css',
      './public/css/app.css',
