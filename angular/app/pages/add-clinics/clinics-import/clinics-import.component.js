class clinicsImportController {
  ...
  save(isValid) {
    ...
    if (isValid) {
      ...
      $window.localStorage.contentType = 'undefined';
      let HonestDoctor = this.API.service('import-clinics', this.API.all('honestdoctor'))
      let $state = this.$state
      let fd = new FormData();
      fd.append('clinics', this.clinics_file)
...
export const ClinicImportComponent = {
  templateUrl: './views/app/pages/add-clinics/clinics-import/clinicsimport.component.html',
  controller: clinicsImportController,
  controllerAs: 'vm',
  bindings: {}
}
